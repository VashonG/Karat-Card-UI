  ...
  return (
    <>
      <div className={props.className}>
        ...
        <div className="h-6 md:h-[22px] relative w-[51%] md:w-full">
          <div className="absolute bottom-[0] flex flex-row sm:gap-10 gap-24 inset-x-[0] items-center justify-start mx-auto md:pr-10 sm:pr-5 pr-[100px] self-stretch w-auto">
          ...
          {!!props?.warning ? (
            <Img
              src={props?.warning}
              className="absolute h-5 right-[6%] top-[0] w-5"
              alt="warning"
            />
          ) : null}
        </div>
