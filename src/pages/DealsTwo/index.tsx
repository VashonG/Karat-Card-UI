    ...
    <>
      <div className="bg-white_A700 flex sm:flex-col md:flex-col flex-row font-inter gap-[34px] items-center mx-auto w-full">
        ...
        <div className="flex-1 h-[1024px] md:px-5 relative w-full">
          <div className="absolute flex inset-x-[0] items-center justify-start mx-auto top-[3%] w-[98%]">
          ...
          <div className="absolute flex h-full inset-y-[0] items-center justify-start my-auto right-[0] w-[63%]">
            <div className="bg-white_A700 flex h-[1024px] md:h-auto items-center justify-start max-w-[709px] p-8 sm:px-5 w-full">
              <div className="flex flex-col gap-5 items-center justify-start w-full">
